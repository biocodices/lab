...
ActiveRecord::Schema.define(version: 20160626231702) do
  ...
  create_table "dna_samples", force: :cascade do |t|
  ...
  add_index "dna_samples", ["sample_id"], name: "index_dna_samples_on_sample_id", using: :btree

  create_table "dna_samples_libraries", id: false, force: :cascade do |t|
    t.integer "library_id",    limit: 4, null: false
    t.integer "dna_sample_id", limit: 4, null: false
  end

  add_index "dna_samples_libraries", ["dna_sample_id", "library_id"], name: "index_dna_samples_libraries_on_dna_sample_id_and_library_id", unique: true, using: :btree

  create_table "dna_sequencings", force: :cascade do |t|
    t.integer "dna_sample_id", limit: 4
  ...
  add_index "dna_sequencings", ["dna_sample_id"], name: "index_dna_sequencings_on_dna_sample_id", using: :btree
  ...
  add_index "nanodrop_quantifications", ["dna_sample_id"], name: "index_nanodrop_quantifications_on_dna_sample_id", using: :btree
  ...
  add_index "qubit_quantifications", ["dna_sample_id"], name: "index_qubit_quantifications_on_dna_sample_id", using: :btree
  ...
  add_foreign_key "dna_samples", "samples"
  add_foreign_key "dna_sequencings", "dna_samples"
  add_foreign_key "dna_sequencings", "sequencings"
  add_foreign_key "nanodrop_quantifications", "dna_samples"
  add_foreign_key "qubit_quantifications", "dna_samples"
